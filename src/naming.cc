...
const char *arg_role(const std::string &call, size_t index)
{
    ...
    static const Roles kRoles[] = {
        ...
        {"read",     {"fileDescriptor", "buffer", "count", nullptr}},
        {"write",    {"fileDescriptor", "buffer", "count", nullptr}},
        {"pread",    {"fileDescriptor", "buffer", "count", nullptr}},
        {"close",    {"fileDescriptor", nullptr, nullptr, nullptr}},
        {"fstat",    {"fileDescriptor", nullptr, nullptr, nullptr}},
        {"fsync",    {"fileDescriptor", nullptr, nullptr, nullptr}},
        {"lseek",    {"fileDescriptor", "offset", "whence", nullptr}},
        {"dup2",     {"oldDescriptor", "newDescriptor", nullptr, nullptr}},
        {"fgets",    {"buffer", "count", "stream", nullptr}},
        {"fputs",    {"text", "stream", nullptr, nullptr}},
        {"fwrite",   {"buffer", "size", "count", nullptr}},
        {"fread",    {"buffer", "size", "count", nullptr}},
        {"strcpy",   {"destination", "source", nullptr, nullptr}},
        {"strncpy",  {"destination", "source", "count", nullptr}},
        {"strcat",   {"destination", "source", nullptr, nullptr}},
        {"memcpy",   {"destination", "source", "count", nullptr}},
        {"memmove",  {"destination", "source", "count", nullptr}},
        {"memset",   {"buffer", nullptr, "count", nullptr}},
        {"connect",  {"fileDescriptor", "address", "length", nullptr}},
        {"bind",     {"fileDescriptor", "address", "length", nullptr}},
        {"accept",   {"fileDescriptor", "address", "length", nullptr}},
        {"send",     {"fileDescriptor", "buffer", "count", nullptr}},
        {"recv",     {"fileDescriptor", "buffer", "count", nullptr}},
    };
    if (index >= 4)
        return nullptr;
