...
const HELP: &str = concat!(
    ...
    "  --source <path>   read C, C++, Rust, Go or assembly source, or a directory\n",
    "                    of it, and record the prototypes it declares: real return\n",
    "                    types, argument types and argument names for anything with\n",
    "                    that name. A binary and its source can be given together:\n",
    "                      astral learn ./thing --source ./thing.rs\n",
